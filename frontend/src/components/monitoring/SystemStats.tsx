...
const SystemStats = ({ metrics }: SystemStatsProps) => {
  return (
    <div className="dashboard-card">
      <h2 className="text-lg font-semibold text-heading mb-4">System Statistics</h2>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="border border-default rounded-lg p-4">
          <h3 className="font-semibold text-heading mb-2">CPU</h3>
        ...
        <div className="border border-default rounded-lg p-4">
          <h3 className="font-semibold text-heading mb-2">Memory</h3>
        ...
        <div className="border border-default rounded-lg p-4">
          <h3 className="font-semibold text-heading mb-2">Disk</h3>
        ...
        <div className="border border-default rounded-lg p-4">
          <h3 className="font-semibold text-heading mb-2">CPU Cores</h3>
