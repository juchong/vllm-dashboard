...
const Modal = ({ children, isOpen, onClose, title }: ModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="surface-primary rounded-lg shadow-xl max-w-2xl w-full max-h-[80vh] overflow-hidden">
        <div className="flex justify-between items-center p-4 border-b border-default">
          ...
          <button onClick={onClose} className="text-faint hover:text-gray-600 dark:hover:text-gray-300">
